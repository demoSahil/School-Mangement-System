...
namespace SMS_WEBUI.Areas.A_Students.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(bool getCount = false)
        {
            ...
            if (getCount)
            {
                return Json(new { count = students.Count }, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult MyTeachers(int? studentId)
        {
            return View();
        }
